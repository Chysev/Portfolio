...
const HiredcvButton = () => {
    return (
        <div className="my-4 mx-0 flex items-center gap-8">
            ...
            <a href="https://github.com/Chysev/Portfolio/blob/main/public/_RESUME-LAYDA.pdf" className="cursor-pointer text-center hover:opacity-[0.8] text-lightcolor underline dark:text-darkcolor" download>
                Resume
            </a>
        </div>
    );
