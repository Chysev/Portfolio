...
import SchoolProjectImg from "../../public/SchoolProject.png"
    ...
    return (
        <ReactCardFlip
            ...
            <div
                ...
                <h1 className="text-center text-2xl text-lightcolor dark:text-white">100 Tula Website</h1>
                ...
                <div className="flex gap-2">
                    ...
                    <Link href="https://github.com/Chysev/21st_MIL_Project">
                        <button
            ...
            <div
                ...
                <div className="flex flex-col gap-2 text-lightcolor dark:text-white">
                    <p>100 Tula Para Kay Stella Website, This project is build with Next and Tailwind</p>
